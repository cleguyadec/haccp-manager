    ...
    <div class="container mx-auto p-6">
        ...
        <div id="addForm" class="hidden mb-6">
            ...
            <form action="{{ route('products.store') }}" method="POST" class="space-y-4 bg-gray-100 dark:bg-gray-800 p-4 rounded-md">
                ...
                <button type="button" onclick="toggleAddForm()" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Annuler</button>
            </form>
        </div>

        {{-- Affichage en tableau pour écran moyen ou plus grand --}}
        ...
        <div class="md:hidden grid grid-cols-1 gap-4">
            ...
            @empty
                <p class="text-center text-gray-700 dark:text-gray-300">Aucun produit trouvé.</p>
            @endforelse
        </div>
